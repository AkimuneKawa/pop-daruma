...
- バランスを変えたら `npm run autoplay -- 200` で次を確認する（難しめの調整）：投資なし（あかだけ作る）＝一人前7割・見習い3割、投資あり（在庫を見て色を切り替え、割安な職人を雇う）＝一人前が中心・名工は1〜2割・閉店ほぼ0（年商 中央値約8,300万）、年商1億円は自動プレイではほぼ届かない、人気★5は上手なプレイで12月ごろ
